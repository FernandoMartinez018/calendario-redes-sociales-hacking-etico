...
import { Sparkles, Send, Copy, RefreshCw, Layers, CheckCircle2 } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all appearance-none"
                >
          ...
          {generated ? (
            <div className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button className="flex-1 py-3 px-4 bg-zinc-800 hover:bg-zinc-700 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-colors">
                  <Copy size={16} />
                  Copiar Texto
                </button>
                <button className="flex-1 py-3 px-4 bg-orange-600 hover:bg-orange-700 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-colors">
                  <PlusCircle size={16} />
                  Programar Post
                </button>
              </div>
            ...
            <div className="h-full flex flex-col items-center justify-center text-center opacity-30 px-10">
              ...
              <p className="font-medium">Define los parámetros a la izquierda para que la IA diseñe tu contenido de hoy.</p>
            </div>
          )}
        </div>
      </div>
...
function PlusCircle({ size }: { size: number }) {
  return <Send size={size} />; // Reusing Send for brevity here
}
